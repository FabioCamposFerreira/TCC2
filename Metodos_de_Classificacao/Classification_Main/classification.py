...
def result(pasta, classifier):
    ...
    for arq in sorted(glob.glob(pasta+"/*")):
        name = arq[len(pasta+'/'):(len(arq) - 4)]
        ...
        c = classifier+';'+pasta+';'+name+';'+str(classe)+';'+str(result)+';'+str(prob[0])+';'+str(
            prob[1])+';'+str(prob[2])+';'+str(prob[3])+';'+str(prob[4])+';'+str(prob[5])+'\n'
        temp.write(c)
...
result('/home/suporte/Documents/TCC2/TCC2/Data Base/DATA 1', 'SVC')
result('/home/suporte/Documents/TCC2/TCC2/Data Base/DATA 1', 'KNN')
result('/home/suporte/Documents/TCC2/TCC2/Data Base/DATA 1', 'RN')
